<template>
  <v-app>
    ...
    -->
    <v-app-bar app color="primary" dark prominent src="https://cdn.vuetifyjs.com/images/backgrounds/vbanner.jpg" height="70px" v-if="isHome">
    ...
    <v-card>
      <v-footer absolute app>
        <v-card-text class="text-center">
          &copy; {{ new Date().getFullYear() }} — <strong>Fiji Travel</strong>
        </v-card-text>
      </v-footer>
    </v-card>
...
export default {
  ...
  data: () => ({
    ...
    menus: [
      ...
      { title: 'My Profile', icon: 'mdi-account', route: '/profile', auth: true },
      { title: 'My Tickets', icon: 'mdi-shopping', route: '/my-order', auth: true },
